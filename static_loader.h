...
namespace qwen_loader
{
    ...
    QwenWeights
    {
        ...
        bf16* final_norm_weight; // model.norm_weight
    ...
    // total model size: 1433.62MB
    const size_t TOTAL_WEIGHT_BYTES = 1503264768;
    ...
    void load_qwen_weights(const std::string& filepath, QwenWeights& weights);
}
